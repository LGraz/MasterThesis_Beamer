    ...
    \begin{columns}
        ...
        \begin{column}{0.45\textwidth}
            \begin{figure}
                ...
                \includegraphics[width=\textwidth]{step_plot/all_years2_itpl.pdf}
            \end{figure}
        \end{column}
    \end{columns}
    % \vfill\null
    ...
    \begin{columns}
        ...
        \begin{column}{0.45\textwidth}
            \begin{figure}
                ...
                \vspace{-1.6cm}
                \includegraphics[width=\textwidth]{step_plot/all_years2_itpl.pdf}
                \includegraphics[width=\textwidth]{step_plot/all_years3_itpl_rew.pdf}
            \end{figure}
        \end{column}
    \end{columns}
    % \vfill\null
    ...
    \begin{columns}
        ...
        \begin{column}{0.45\textwidth}
            \begin{figure}
                ...
                \vspace{-1.6cm}
                \includegraphics[width=\textwidth]{step_plot/all_years3_itpl_rew.pdf}
                \includegraphics[width=\textwidth]{step_plot/all_years4_ndvi_scl.pdf}
            \end{figure}
        \end{column}
    \end{columns}
    % \vfill\null
    ...
    \begin{columns}
        ...
        \begin{column}{0.45\textwidth}
            \begin{figure}
                % \centering
                \vspace{-1.6cm}
                \includegraphics[width=\textwidth]{step_plot/all_years5_show_res.pdf}
                \includegraphics[width=\textwidth]{step_plot/all_years6_corr.pdf}
            \end{figure}
        \end{column}
    \end{columns}
    % \vfill\null
    ...
    \begin{columns}
        ...
        \begin{column}{0.45\textwidth}
            \begin{figure}
                ...
                \vspace{-1.6cm}
                \includegraphics[width=\textwidth]{step_plot/all_years6_corr.pdf}
                \includegraphics[width=\textwidth]{step_plot/all_years7_uncert.pdf}
            \end{figure}
        \end{column}
    \end{columns}
    % \vfill\null
